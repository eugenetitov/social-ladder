...
namespace SocialLadder.Droid.Fragments.Challenges
{
    ...
    public class FlyeringFragment : BaseFragment<FlyeringViewModel>, View.IOnScrollChangeListener, IOnMapReadyCallback
    {
        protected override int FragmentId => Resource.Layout.ChallengeFlyeringLayout;
