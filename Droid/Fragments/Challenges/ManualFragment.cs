...
namespace SocialLadder.Droid.Fragments.Challenges
{
    ...
    public class ManualFragment : BaseFragment<ManualViewModel>, View.IOnScrollChangeListener, IOnMapReadyCallback
    {
        protected override int FragmentId => Resource.Layout.ChallengesManualLayout;
